...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/bloc_note')) {
            // user_blocnote_default_index
            if ($pathinfo === '/bloc_note') {
                return array (  '_controller' => 'User\\BlocNoteBundle\\Controller\\DefaultController::indexAction',  '_route' => 'user_blocnote_default_index',);
            }

            // user_blocnote_default_show
            if (0 === strpos($pathinfo, '/bloc_note/show') && preg_match('#^/bloc_note/show/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_blocnote_default_show')), array (  '_controller' => 'User\\BlocNoteBundle\\Controller\\DefaultController::showAction',));
            }

            // user_blocnote_default_report
            if (0 === strpos($pathinfo, '/bloc_note/report') && preg_match('#^/bloc_note/report/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_blocnote_default_report')), array (  '_controller' => 'User\\BlocNoteBundle\\Controller\\DefaultController::reportAction',));
            }
